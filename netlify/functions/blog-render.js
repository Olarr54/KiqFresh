...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .brand{font-family:'Bebas Neue',sans-serif;font-size:2rem;letter-spacing:.06em;color:var(--blue);text-decoration:none}
    nav a{color:#777;text-decoration:none;font-size:.88rem;margin-left:1.5rem;font-weight:600}
    nav a:hover{color:var(--cream)}
    main{max-width:720px;margin:0 auto;padding:3rem 1.5rem 5rem}
    .meta{font-size:.75rem;color:#555;text-transform:uppercase;letter-spacing:.12em;margin-bottom:1rem}
    h1.post-title{font-family:'Bebas Neue',sans-serif;font-size:3.2rem;letter-spacing:.02em;line-height:1.05;margin-bottom:1.25rem}
    ...
    .body h1,.body h2,.body h3{font-family:'Bebas Neue',sans-serif;letter-spacing:.03em;color:var(--cream);margin:2rem 0 .75rem}
    .body h1{font-size:2.2rem}.body h2{font-size:1.8rem}.body h3{font-size:1.3rem}
    ...
    .body blockquote{border-left:3px solid var(--blue);padding:.5rem 1rem;margin:1.5rem 0;color:#999;font-style:italic}
    ...
    .cta a{display:inline-block;background:var(--blue);color:#111;padding:.7rem 1.5rem;border-radius:6px;font-weight:800;text-decoration:none;font-size:.95rem}
    footer{text-align:center;padding:2rem;color:#444;font-size:.78rem;border-top:1px solid #1a1a1a;margin-top:2rem}
...
<header>
  ...
  <nav><a href="/blog/">Blog</a><a href="/booking.html">Book Now</a></nav>
</header>
<main>
  ...
  <div class="cta">
    <p>Ready for fresh kicks? KiqFresh offers professional shoe cleaning in Reading — starting from just £15.</p>
    <a href="/booking.html">Book a Clean</a>
  </div>
</main>
<footer><a href="/">kiqfresh.net</a> &middot; Professional Shoe Cleaning, Reading UK</footer>
</body>
</html>`;
}
